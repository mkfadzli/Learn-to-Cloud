...
|-----|-------|-------------------|
| 1 | [Identity and Access Management](1-csf-iam-implementation.md) | Secure IAM controls for your Journal API |
| 2 | [Data Protection & Secrets](2-csf-data-protection.md) | Encryption, key management, and secure secrets |
| 3 | [Network Security](3-csf-network-security.md) | Secure networking and connectivity |
| 4 | [Security Monitoring](4-csf-monitoring.md) | Real-time monitoring and alerting |
| 5 | [Threat Detection & Response](5-csf-incident-response.md) | Automated threat detection and incident response |
| 6 | [Capstone Project](6-capstone.md) | Comprehensive security implementation |
